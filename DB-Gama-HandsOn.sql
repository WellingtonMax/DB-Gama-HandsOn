...
-- INSERT INTO cliente VALUES (NULL, 'Sérgio Reis', 'sergiolinguissa@seara.com', 'melhorlinguiçadobrasil', '125.756.125-82');
...
-- INSERT INTO endereco VALUES (NULL, 'apartamento', 'Rua Batista de Oliveira', 4432, 'apt 202', 'centro', 'Belo Horizonte', '29535-980', 'MG', 3);
-- INSERT INTO endereco VALUES (NULL, 'casa', 'Rua Desdeth Salgado', 342, null, 'São Mateus', 'Santos Dumont', '45634-333', 'SP', 4);
-- INSERT INTO endereco VALUES (NULL, 'casa', 'Rua Marcelino Pão e Vinho', 33, null, 'Alto dos Passos', 'Lagoa Dourada', '12357-434', 'DF', 5);
-- INSERT INTO endereco VALUES (NULL, 'apartamento', 'Avenida Dr. Romualdo', 666, 'apt 3001 bloco A', 'centro', 'Osasco', '54356-876', 'RJ', 6);
-- INSERT INTO endereco VALUES (NULL, 'casa', 'travessa Renato Leite', 49, null, 'Benfica', 'Rio de Janeiro', '34546-785', 'RS', 7);
-- INSERT INTO endereco VALUES (NULL, 'apartamento', 'avenida Rio Branco', 3652, 'apt 202', 'Bom Pastor', 'Juiz de fora', '12345-745', 'BA', 8);
-- INSERT INTO endereco VALUES (NULL, 'apartamento', 'Travessa Pinheiro Dourado', 14, 'casa 3', 'Vila Esperança', 'Belo Horizonte', '98556-974', 'MT', 9);
